...
(function() {
  ...
  BacklogDB = (function() {
    ...
    BacklogDB.prototype.updateConnection = function(cid, options, callback) {
      var isSSL, name, self, setAttribute, sql, _ref1,
        _this = this;
      self = this;
      ...
      sql.set('server_pass', (_ref1 = options.server_pass) != null ? _ref1 : null);
    ...
    BacklogDB.prototype.deleteBuffer = function(cid, bid, callback) {
      return this.db.run('DELETE FROM buffers WHERE cid = $cid AND bid = $bid', {
        $cid: cid,
        $bid: bid
      }, function(err) {
        if (err) {
