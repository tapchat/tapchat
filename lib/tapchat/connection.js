...
(function() {
  ...
  Connection = (function(_super) {
    ...
    function Connection(user, engine, options, callback) {
      ...
      this.engine.db.selectBuffers(this.id, (function(_this) {
    ...
    Connection.prototype.reconnect = function(callback) {
      return this.disconnect((function(_this) {
        return function() {
          _this.connect();
          if (callback) {
            return callback();
    ...
    Connection.prototype.addBuffer = function(bufferInfo) {
      ...
      buffer.on('event', (function(_this) {
    ...
    Connection.prototype.sendBacklog = function(client, done) {
      var queue, send;
      ...
      return this.getBacklog(((function(_this) {
        return function(event) {
        ...
        return function() {
          ...
          if (_this.isConnecting()) {
            ...
            for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
              buffer = _ref2[_j];
              callback(merge(B.connecting(_this), {
                bid: buffer.id
              }));
            }
          }
    ...
    Connection.prototype.edit = function(options, callback) {
      return this.engine.db.updateConnection(this.id, options, (function(_this) {
        return function(row) {
    ...
    Connection.prototype.acceptCert = function(fingerprint, accept, done) {
      ...
      if (!((this.pendingSSL != null) && this.pendingSSL.cert.fingerprint === fingerprint)) {
        return done();
      }
      fingerpint = this.pendingSSL.fingerpint;
      callback = this.pendingSSL.callback;
      this.pendingSSL = null;
      if (!accept) {
        callback(false);
        done();
        return;
    ...
    Connection.prototype.createBuffer = function(name, type, callback) {
      var self;
      self = this;
      return this.engine.db.insertBuffer(this.id, this.user.id, name, type, (function(_this) {
    ...
    Connection.prototype.addEventListeners = function() {
      ...
      for (signalName in _ref1) {
        ...
        _results.push((function(_this) {
          return function(signalName, signalHandler) {
    ...
    Connection.prototype.signalHandlers = {
      ...
      selfJoin: function(channel, message, over) {
        return this.getOrCreateBuffer(channel, 'channel', (function(_this) {
          return function(buffer) {
      ...
      selfPart: function(channel, reason, over) {
        var buffer;
        if (buffer = this.getBuffer(channel)) {
          return buffer.setJoined(false, (function(_this) {
            return function() {
              return buffer.addEvent({
      ...
      selfMessageOrAction: function(type, to, text, over) {
        ...
        if (to.match(/^[&#]/)) {
          ...
          return this.getOrCreateBuffer(to, 'conversation', (function(_this) {
            return function(buffer) {
              if (!buffer) {
                return over();
              }
      ...
      message: function(nick, to, text, message, over) {
        ...
        if (to.match(/^[&#]/)) {
          ...
          return this.getOrCreateBuffer(bufferName, 'conversation', (function(_this) {
            return function(buffer) {
              return buffer.unarchive(function() {
                return buffer.addEvent({
                  type: 'buffer_msg',
      ...
      invalidCert: function(cert, error, callback, over) {
        if (this.sslFingerprint === cert.fingerprint) {
          ...
          return this.user.broadcast(B.invalidCert(this), over);
        }
      },
