...
(function() {
  var B, ChannelBuffer, CoffeeScript, Connection, ConsoleBuffer, ConversationBuffer, EventEmitter, Irc, WorkingQueue, compact, count, del, ends, extend, flatten, last, merge, starts, util, _, _ref,
  ...
  Connection = (function(_super) {
    ...
    Connection.prototype.signalHandlers = {
      ...
      selfQuit: function(reason, over) {
        ...
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
          buffer = _ref1[_i];
          if (buffer.type instanceof ChannelBuffer) {
            buffer.setJoined(false);
          }
        }
        return this.addEventToAllBuffers({
