...
(function() {
  var B, BacklogDB, Base64, Buffer, CoffeeScript, Config, Connection, Crypto, DataBuffer, Engine, Express, Fs, Gzippo, Http, LocalStrategy, Log, Passport, PasswordHash, Path, PushClient, SessionStore, Url, Util, WebSocket, WorkingQueue, compact, count, del, ends, extend, flatten, last, merge, starts, _, _ref;
