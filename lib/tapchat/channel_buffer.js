...
(function() {
  ...
  ChannelBuffer = (function(_super) {
    ...
    ChannelBuffer.prototype.setJoined = function(joined, callback) {
      return this.unarchive((function(_this) {
        return function() {
    ...
    ChannelBuffer.prototype.renameMember = function(oldNick, newNick) {
      var member;
      if (!(member = this.members[oldNick])) {
        throw "" + this.name + " member not found: " + oldNick + " (new: " + newNick + "). Members: " + (JSON.stringify(this.members)) + ".";
      }
    ...
    ChannelBuffer.prototype.getIsActive = function() {
      return ChannelBuffer.__super__.getIsActive.apply(this, arguments) && this.isJoined;
    };
...
//# sourceMappingURL=channel_buffer.map
